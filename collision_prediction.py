...
# python collision_prediction.py --source inference\Jur_2_demo.mp4 --classes 0 1 2 3 5 6 7 16

def detect(save_img=False):
    ###########################
    obs_len = opt.obs_len
    pred_len = opt.pred_len
    resultFPS = opt.resultFPS
    warning_count = 0
    ###########################
...
if __name__ == '__main__':
    ...
    parser.add_argument('--classes', nargs='+', type=int, help='filter by class: --class 0, or --class 0 2 3', default=[0, 1, 2, 3, 5, 6, 7, 16])
    parser.add_argument('--agnostic-nms', action='store_true', help='class-agnostic NMS')
    parser.add_argument('--augment', action='store_true', help='augmented inference')
    parser.add_argument('--update', action='store_true', help='update all models')
    parser.add_argument('--project', default='runs/predict_collision', help='save results to project/name')
    parser.add_argument('--name', default='exp', help='save results to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    parser.add_argument('--trace', action='store_false', help='trace model')
    #######################################################
    ...
    parser.add_argument('--obs-len', type=int, default=12, help='number of observed positions to predict future trajectory')
    parser.add_argument('--pred-len', type=int, default=50, help='frames count to predict')
